    ...
    content = (
        <div className="profile-container">
          ...
          <div className="profile-description">
            My name is {props.admin.username} and I’m a student at UZH. I love organizing lasagne
...
const Event = () => {
  ...
  const adminButtons = (
      <div>
        ...
        <button className="event-button add-button" onClick={() => modalOpenTask()}>
  ...
  if (event) {
    content = (
      <div>
        ...
        <div className="row">
          <div className="col-7">
            <EventOverview event={event} admin={admin} collaborators={collaborators} />
          </div>
          <div className="col-4">
